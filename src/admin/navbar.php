    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                ...
                <a class="nav-item nav-link <?php if ($title === 'Lelang') echo 'active font-weight-bold' ?>" href="lelang.php">Barang Lelang</a>
                ...
                <a class="nav-item nav-link <?php if ($title === 'Petugas') echo 'active font-weight-bold' ?>" href="petugas.php">Petugas</a>
            </div>
        </div>
